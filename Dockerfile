...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "extras;android;m2repository"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "extras;google;m2repository"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "ndk;21.1.6352462"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "build-tools;29.0.2"
